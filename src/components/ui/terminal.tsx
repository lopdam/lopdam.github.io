...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-card z-0 h-full max-h-[500px] w-full rounded-xl border shadow-lg overflow-hidden",
        className
      )}
    >
      <div className="border-border flex flex-col gap-y-2 border-b p-3 md:p-4">
